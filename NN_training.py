...
def parse_args():
    ...
    parser.add_argument('--labelpath', type=str, default= 'data/beluchting/Qair_residuals_interpolated.csv', help='Path to load the labels')
    parser.add_argument('--output_path', type=str, default= 'output/output_Qair_residuals_test2', help='Path for saving models and metrics')    
    ...
    parser.add_argument('--target', type=str, default='Qair_residuals', help='Target to train on')
...
if __name__ == "__main__":
    ...
    train_dataset = dataset.MicroscopicImages(root=args.imagedatapath, magnification=10, start_folder='2023-10-26', end_folder='2024-01-26', label_path=args.labelpath, transform=train_transform) 
    ...
    val_dataset = dataset.MicroscopicImages(root=args.imagedatapath, magnification=10, start_folder='2023-10-26', end_folder='2024-01-26', label_path=args.labelpath, transform=val_transform)   
